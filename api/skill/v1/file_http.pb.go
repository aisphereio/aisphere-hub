...
type FileServiceHTTPClient interface {
	CreateFile(ctx context.Context, req *CreateFileRequest, opts ...http.CallOption) (rsp *FileContent, err error)
	DeleteFile(ctx context.Context, req *DeleteFileRequest, opts ...http.CallOption) (rsp *DeleteFileResponse, err error)
	GetFile(ctx context.Context, req *GetFileRequest, opts ...http.CallOption) (rsp *FileContent, err error)
	ListFiles(ctx context.Context, req *ListFilesRequest, opts ...http.CallOption) (rsp *FileContents, err error)
	UpdateFile(ctx context.Context, req *UpdateFileRequest, opts ...http.CallOption) (rsp *FileContent, err error)
}
...
func (c *FileServiceHTTPClientImpl) CreateFile(ctx context.Context, in *CreateFileRequest, opts ...http.CallOption) (*FileContent, error) {
	var out FileContent
...
func (c *FileServiceHTTPClientImpl) GetFile(ctx context.Context, in *GetFileRequest, opts ...http.CallOption) (*FileContent, error) {
	var out FileContent
...
func (c *FileServiceHTTPClientImpl) UpdateFile(ctx context.Context, in *UpdateFileRequest, opts ...http.CallOption) (*FileContent, error) {
	var out FileContent
	pattern := "/v1/skills/{skill_name}/contents/{path=**}"
	path := http.BuildPath(pattern, in)
	opts = append([]http.CallOption{
