...
const file_skill_v1_skill_proto_rawDesc = "" +
	...
	"\breleases\x18\x01 \x03(\v2\x16.skill.v1.SkillReleaseR\breleases2\xf2\x1a\n" +
	...
	"/v1/skills\x12\xa3\x01\n" +
	"\n" +
	"ListSkills\x12\x1b.skill.v1.ListSkillsRequest\x1a\x1c.skill.v1.ListSkillsResponse\"Z\x92\xf4\x18D\b\x03\x12'\n" +
	"\x04view\x12\x10skill:collection\x1a\vhub-service \x03\x1a\x17\b\x01\x12\x0ehub.skill.list\x1a\x03low\x82\xd3\xe4\x93\x02\f\x12\n" +
